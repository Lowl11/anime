...
class ManageAnimeForm(forms.Form):
    ...
    title_rus.widget.attrs.update({'class': 'form-control', 'autocomplete': 'off'})
    title_foreign.widget.attrs.update({'class': 'form-control', 'autocomplete': 'off'})
    season.widget.attrs.update({'class': 'form-control', 'autocomplete': 'off'})
    description.widget.attrs.update({'class': 'form-control'})
    episodes_quantity.widget.attrs.update({'class': 'form-control', 'autocomplete': 'off'})
    start_date.widget.attrs.update({'class': 'form-control', 'autocomplete': 'off'})
